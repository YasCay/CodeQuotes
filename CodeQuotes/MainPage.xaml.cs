namespace CodeQuotes
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            var startColor = System.Drawing.Color.FromArgb(random.Next(0, 255), random.Next(0, 255), random.Next(0, 255));

            var endColor = System.Drawing.Color.FromArgb(random.Next(0, 255), random.Next(0, 255), random.Next(0, 255));
